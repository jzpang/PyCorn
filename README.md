...
windowslidesize: the window size when you scan the genome. Windows starts from the 1st element and keeps shifting right by windowslidesize element. You can choose a big windowslidesize if you have a large input genome sequnce.
